...
my $left_border = 1;
my $right_border = $xsize - $left_border;
my $vertical_increment = 3;
my $label_increment = 1.5;
my $annotation_increment = 2;
my $textline_increment = 0.5;
my $gene_height = 0.2;
my $negative_correction = 0.25;
my $annotationy = $ysize + $vertical_increment;
my $position = -1;
my $gene = '';
my $length = -1;
my $pos_hue = -1;
...
my ($s, $e);
my ($x, $y);
my ($draw_start, $draw_end);
my ($leftx, $centerx, $rightx);
my ($lastx, $lasty1, $lasty2);
my ($hx, $hy1, $hy2);
my $geney;
my $labely;
my $line;
